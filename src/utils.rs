...
pub fn read_mutations() -> Vec<(u32, String)> {
    ...
    println!("Enter the position, space, and the amino acid to mutate to (or type 'end' to finish)");
...
pub fn design_primers(changes: Vec<(u32, String)>, sequence: &str) -> (String, String) {
    let codon_table: HashMap<&str, &str> = [
        ("F", "TTT"), ("L", "CTG"), ("S", "AGC"), ("Y", "TAC"), ("*", "TGA"),
        ("C", "TGC"), ("W", "TGG"), ("P", "CCG"), ("H", "CAC"), ("Q", "CAG"),
        ("R", "CGG"), ("I", "ATC"), ("M", "ATG"), ("T", "ACC"), ("N", "AAC"),
        ("K", "AAG"), ("V", "GTG"), ("A", "GCC"), ("D", "GAC"), ("E", "GAG"),
        ("G", "GGC")
    ].iter().cloned().collect();
